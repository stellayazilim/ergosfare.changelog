  ...
  return (
    <>
      ...
      <h1 className="mt-14 font-display text-4xl/tight font-light text-white">
        Modern Mediator for .NET developers{' '}
        <span className="text-sky-300">
          Built by developers, for developers
        </span>
      </h1>
      <p className="mt-4 text-sm/6 text-gray-300">
        Ergosfare is a lightweight .NET messaging framework that helps you
        orchestrate commands, queries, and events with clarity. It’s fast,
        extensible, and built for developers who value simplicity.
      </p>
